...
public class ArrayItems {
    ...
    public int[] IDs = {
            R.drawable.guide_card_day1
            ,R.drawable.guide_card_day2
            ,R.drawable.guide_card_day3
            ,R.drawable.guide_card_day4
            ,R.drawable.guide_card_day5
            ,R.drawable.guide_card_day6
            ,R.drawable.guide_card_day7
            ,R.drawable.guide_card_day8
            ,R.drawable.guide_card_day9
            ,R.drawable.guide_card_day10
            ,R.drawable.guide_card_day11
            ,R.drawable.guide_card_day12
            ,R.drawable.guide_card_day13
            ,R.drawable.guide_card_day14
            ,R.drawable.guide_card_day15
            ,R.drawable.guide_card_day16
            ,R.drawable.guide_card_day17
            ,R.drawable.guide_card_day18
            ,R.drawable.guide_card_day19
            ,R.drawable.guide_card_day20
            ,R.drawable.guide_card_day21
            ,R.drawable.guide_card_day22
            ,R.drawable.guide_card_day23
            ,R.drawable.guide_card_day24
            ,R.drawable.guide_card_day25
            ,R.drawable.guide_card_day26
            ,R.drawable.guide_card_day27
            ,R.drawable.guide_card_day28
            ,R.drawable.guide_card_day29
            ,R.drawable.guide_card_day30
    };
    ...
    public int[] emoIcons = {R.drawable.ic_emotion_calmness, R.drawable.ic_emotion_dullness, R.drawable.ic_emotion_sadness
            , R.drawable.ic_emotion_anger, R.drawable.ic_emotion_satisfied, R.drawable.ic_emotion_emptiness};

    public String[] emoGuides = {
            "오늘의 기분은 평온해요"
            ,"오늘의 기분은 무덤덤해요"
            ,"오늘의 기분은 슬퍼요"
            ,"오늘의 기분은 화나요"
